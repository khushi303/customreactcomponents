    ...
    return (
        <>
            <div className="container xl:max-w-[1164px] mx-auto px-3 pt-9">
                <form className="flex items-center justify-center flex-col gap-4 w-full" onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <input
                            ...
                            className="w-full p-2 rounded-lg bg-red-200"
                        />
                        {formErrors.name && (
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-100 py-2 ${formErrors.number ? "error" : ""}`}
                            maxLength={10}
                        />
                        {formErrors.number && (
