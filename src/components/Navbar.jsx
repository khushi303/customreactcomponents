        ...
        <>
            <div className='bg-red-200'>
                <div className='container mx-auto px-3 max-w-[1164px]'>
                    <div className='flex items-center gap-6 md:justify-between py-4'>
                    ...
                    <div className={`fixed top-0 bottom-0 min-h-screen z-50 w-[350px] transition-all duration-300 ease-linear bg-red-200 ${Open ? "left-0" : "left-[-350px]"}`}>
                        <div className='flex items-center justify-center gap-5 flex-col w-full h-full relative z-50'>
                            <Link onClick={() => setopen(!Open)}  to={'/'} className='text-lg font-medium text-black tracking-wide'>Home</Link>
                            <Link onClick={() => setopen(!Open)}  to={'/Form'} className='text-lg font-medium text-black tracking-wide'>Form</Link>
                            <Link onClick={() => setopen(!Open)}  to={'/Slider'} className='text-lg font-medium text-black tracking-wide'>Slider</Link>
                            <Link onClick={() => setopen(!Open)}  to={'/Accordian'} className='text-lg font-medium text-black tracking-wide'>Accordian</Link>
                            <Link onClick={() => setopen(!Open)}  to={'/Tabs'} className='text-lg font-medium text-black tracking-wide'>Tabs</Link>
